...
def create_parser():
    ...
    parser.add_argument('--mega_cutoff_step_size', type=int, default=5, help="Step size for adjusting the mega_cutoff when using the MEGA goal filtering strategy.")
    ...
    parser.add_argument('--target_computation', type=str, default="min", help="Type of target critic value aggregation.")
    ...
    parser.add_argument("--grid_size", type=int, default=30, help="Size of grid used for logging different quantities of ucb objective.")
    parser.add_argument("--adaptation_rate", type=int, default=25, help="Adaptation Rate.")  
