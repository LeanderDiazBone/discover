...
class ArmPushEasy(ArmEnvs):
    ...
    def _set_environment_attributes(self):
        ...
        #self.goal_reach_thresh = 0.1 # Hard target
    ...
    def _get_initial_state(self, rng):
        ...
        cube_q_xy = jnp.array([-0.3, 0.65])+ self.cube_noise_scale * jax.random.uniform(subkey1, [2], minval=-1) #self.sys.init_q[:2] 
    ...
    def _get_initial_goal(self, pipeline_state: base.State, rng):
        ...
        cube_goal_pos = jnp.array([0.3, 0.65, 0.03]) + jnp.array([self.goal_noise_scale, self.goal_noise_scale, 0]) * jax.random.uniform(subkey, [3], minval=-1) # Push Far
