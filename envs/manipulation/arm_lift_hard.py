...
class ArmLiftHard(ArmEnvs):
    ...
    def _set_environment_attributes(self):
        ...
        self.cube_noise_scale = 0.025#0.25
    ...
    def _get_initial_goal(self, pipeline_state: base.State, rng):
        ...
        cube_goal_pos = jnp.array([-0.25, 0.65, 0.3]) + jnp.array([self.goal_noise_scale, self.goal_noise_scale, 0]) * jax.random.uniform(subkey, [3], minval=-1) # Lift far
